...
// Payment-first booking materialization is a separate state machine from the
// gateway payment status. A captured payment can require a safe retry or
// operator reconciliation without being incorrectly marked as failed.
export const PAYMENT_BOOKING_STATUS = {
  PENDING: "PENDING",
  SUCCEEDED: "SUCCEEDED",
  FAILED_REQUIRES_RECONCILIATION: "FAILED_REQUIRES_RECONCILIATION",
};

export const PAYMENT_BOOKING_STATUS_VALUES = [
  PAYMENT_BOOKING_STATUS.PENDING,
  PAYMENT_BOOKING_STATUS.SUCCEEDED,
...
export const PAYMENT_ORDER_STATUS_VALUES = [
  ...
  PAYMENT_ORDER_STATUS.FAILED_RETRYABLE,
  PAYMENT_ORDER_STATUS.RECOVERY_REQUIRED,
];
...
export const REFUND_STATUS = {
  ...
  REFUND_REQUIRES_RECONCILIATION: "REFUND_REQUIRES_RECONCILIATION",
