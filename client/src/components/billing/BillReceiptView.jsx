...
export default function BillReceiptView({ bill }) {
  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        <div className="p-5 sm:p-8 dark:bg-[#171b23]">
          ...
          <div className="mt-6 grid gap-x-6 gap-y-3 border-y border-gray-200 py-5 text-sm dark:border-white/10 sm:grid-cols-2">
            ...
            <p><span className="font-semibold text-gray-700 dark:text-slate-300">Booking:</span> <span className="font-bold text-gray-950 dark:text-slate-100">{booking.bookingCode || "Walk-in"}</span></p>
          </div>
          ...
          <div className="mt-6 ml-auto max-w-sm rounded-2xl bg-gray-50 p-4 text-sm ring-1 ring-gray-100 dark:bg-[#11151b] dark:ring-white/10">
            ...
            <div className="flex justify-between py-1"><span className="font-semibold text-gray-700">Discount</span><span className="font-bold text-emerald-700">-{money(bill?.discount?.value)}</span></div>
      ...
      <div className="pointer-events-none absolute left-[-10000px] top-0 w-[794px]" aria-hidden="true"><BillReceiptPrint bill={bill} /></div>
    </div>
  );
}
