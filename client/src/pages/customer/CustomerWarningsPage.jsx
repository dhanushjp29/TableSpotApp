...
export default function CustomerWarningsPage() {
  ...
  const handleReply = async (warning, message) => {
    ...
    toast.success("Reply sent to the admin and restaurant owner.");
    reloadWarnings();
  };
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted">
          Warnings issued to restaurants following reports you filed
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <Card className="p-8">
          <EmptyState
            title="No warnings"
            description="When a warning is issued to a restaurant you reported, it will show up here."
          />
        </Card>
      ) : (
          ...
          {warnings.map((warning) => (
            ...
            >
              ...
              <WarningConversation
                ...
                placeholder="Reply to the admin and restaurant owner regarding this warning..."
              />
            </Card>
          ))}
        </div>
